$(document).on('click', '.create-btn', function (e) {
    e.preventDefault();
    $('#CreateAboutUsModal').modal('show');

});

$(document).on('click', '#close', function (e) {
    $('#CreateAboutUsModal').modal('hide');
...
$(document).ready(function () {
    ...
    var count = 1;
    //CREATE AboutUs
    $(document).on('submit', '#CreateAboutUsForm', function (e) {
        e.preventDefault();

        let formData = new FormData($('#CreateAboutUsForm')[0]);
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if ($.isEmptyObject(response.error)) {
                    $('#CreateAboutUsModal').modal('hide');
                    $('#CreateAboutUsModal form :input').val("");
                   ...
                   tinymce.get(tinymce_editor_id).setContent('');
                    ...
                    count = 1;
                    $('#aboutUs_table').DataTable().ajax.reload();
    ...
    $("#aboutUs_table").on("click", ".edit_btn", function (e) {
        e.preventDefault();
    ...
    $(document).on('submit', '#EditAboutUsForm', function (e) {
        ...
        var id = $('#get_AboutUs_id').val();

        let EditFormData = new FormData($('#EditAboutUsForm')[0]);
    ...
    $("#aboutUs_table").on("click", ".dlt_btn", function (e) {
        e.preventDefault();
