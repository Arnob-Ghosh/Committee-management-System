...
$(document).ready(function () {
    ...
    $(document).on('submit', '#CreatespecificationCategoryForm', function (e) {
        ...
        $.ajax({
            type: "POST",
            url: "/feature-phone/specification-category-create",
            data: formData,
            contentType: false,
            processData: false,
    ...
    $("#specificationCategory_table").DataTable({
        responsive: true,
        ajax: {
            url: "/feature-phone/specification-category-list-data",
            dataSrc: "data",
        },
    ...
    $("#specificationCategory_table").on("click", ".edit_btn", function (e) {
        ...
        $.ajax({
            type: "GET",
            url: "/feature-phone/specification-category-edit/" + id,
            success: function (response) {
    ...
    $("#specificationCategory_table").on("click", ".dlt_btn", function (e) {
        ...
        $(document).on("click", ".confrim_dlt", function () {
            $.ajax({
                type: "get",
                url: "/feature-phone/specification-category-delete/" + id,
                contentType: false,
                processData: false,
                success: function (response) {
                    // console.log(response.message);
