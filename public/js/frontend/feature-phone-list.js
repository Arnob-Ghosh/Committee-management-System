$('.item-hover-variant-image a').hover(
    ...
    function () {
        ...
        // a=''+base_url+'/uploads/product/featurephone/variant/';
        //  alert(a)
        var image = $(this).find('img').attr('src')
        var first_image = image.replace('' + base_url + '/uploads/product/featurephone/variant/', '');
            ...
            if (response.data == '') {
                ...
                <div class="product product-7 text-center">\
                    <figure class="product-media">\
                        <a href="/feature-phone-view/'+ item.id + '" id="display-append-img-div-' + i + '" class="display-append-item-hover">\
                    ...
                    <div class="product-body">\
                        <h2 class="product-title"><a href="/feature-phone-view/'+ item.id + '">' + item.model_name +
                        '</a></h2>\
             ...
             ');
                    $.each(item.feature_phone, function (index, data) {
                        ...
                        $('#display-append-variant-image-' + i + '').append(
                            '<a href="javascript:void(0)" id="display-append-ab-' + i + '" class="append-active">\
...
$(document).on('click', '.brand-sort', function () {
    ...
    $.ajax({
        ...
        ');
            ...
            <div class="product product-7 text-center">\
                <figure class="product-media">\
                    <a href="/feature-phone-view/'+ item.id + '" id="brand-append-img-div-' + i + '" class="brand-append-item-hover">\
                        <img src="' + item.feature_phone[0].back_image +
