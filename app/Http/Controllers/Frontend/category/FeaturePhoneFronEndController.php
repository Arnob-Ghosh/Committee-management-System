...
class FeaturePhoneFronEndController extends Controller
{
    ...
    {
        $meta_tags= DB::table('meta_tags')
        ->select('meta_keyword','meta_description')
        ->where('main_page_name','=','feature-phone')
        ->get();
        ...
        $brands = DB::table('brands')
            ...
            ->get();
        // return $data;
        return view('frontend/category/feature-phone/feature-phone-list', compact('meta_tags','data', 'brands', 'sliders', 'camera', 'display_size', 'battery', 'network', 'feature_phone_overview_imgs', 'career_link'));
    }
    ...
    {
        $data=FeaturePhoneDescription::where('model_id',$id)->get();
         return response()->json([
            'status' => 200,
            'data' => $data,
        ]);
    ...
    public function featurePhoneView($id)
    {
        ...
        return view('frontend/category/feature-phone/feature-phone-view-new', compact('meta_tags','data', 'descriptions', 'categories', 'phone_details', 'feature_phone_overview_imgs', 'over_view_images', 'career_link'));
    }
