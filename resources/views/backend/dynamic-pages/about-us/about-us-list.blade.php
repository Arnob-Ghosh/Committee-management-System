...
@section('title', 'Dynamic Pages - About Us')
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h5 class="m-0"><strong><i class="fas fa-clipboard-list"></i> ABOUT US</strong></h5>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="pt-3">
                                <div class="table-responsive">
                                    <table id="aboutUs_table" class="table-bordered display" width="100%">
                                        <thead>
                                            <tr>
                                                <th>Sl</th>
                                                <th>Description</th>
...
<!--Create aboutUs Modal -->
<div class="modal fade" id="CreateAboutUsModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><strong>CREATE ABOUT US DESCRIPTION</strong></h5>
            </div>


            <!-- Create AboutUs Form -->
            <form id="CreateAboutUsForm" method="POST" enctype="multipart/form-data">
...
<!-- End Create AboutUs Modal -->

<!--Edit AboutUs Modal -->
<div class="modal fade" id="EditAboutUsModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><strong>EDIT AboutUs</strong></h5>
            </div>


            <!-- Update AboutUs Form -->
            <form id="EditAboutUsForm" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <input type="hidden" id="get_AboutUs_id" name="" class="form-control">

                        <label for="description" class="form-label">AboutUs Name<span
                                class="text-danger"><strong>*</strong></span></label>
            ...
            <!-- End Update AboutUs Form -->

        </div>
    </div>
</div>
<!-- End Edit AboutUs Modal -->

<!-- End Delete AboutUs Modal -->
<div class="modal fade" id="DeleteAboutUsModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">

            <div class="modal-body">
                <input type="hidden" name="" id="AboutUs_id">
...
<script type="text/javascript" src="{{asset('js/backend/AboutUs.js')}}"></script>
