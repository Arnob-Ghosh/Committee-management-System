                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="">
                                            ...
                                            <!--<input type="text" name="village_id" id="village_id" class="form-control" placeholder="Your Village" >-->
                                    ...
                                    <div class="col-lg-3">
                                        <div class="">
                                            ...
                                            <!--    @endforeach-->
                                            <!--</select>-->
                                            <input type="text" name="designation_id" id="designation_id" class="form-control" placeholder="Enter Designation" >
