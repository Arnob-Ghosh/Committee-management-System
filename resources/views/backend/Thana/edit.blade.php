                    ...
                    <div class="card radius-10 w-100">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <div>
                                    <h5 class="mb-0">Update Thana Information</h5>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name" class="form-control" placeholder="District Name" value="{{ $thana->name }}" required autocomplete="off">
                                        </div>
                                        <div class="mb-3">
