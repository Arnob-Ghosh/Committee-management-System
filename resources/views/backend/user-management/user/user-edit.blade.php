                                ...
                                <form id="EditUserForm" action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6 col-sm-12">
                                            ...
                                            <h6 class="text-danger pt-1" id="edit_wrongpassword"
                                        ...
                                        <div class="form-group col-md-6 col-sm-12">
                                            ...
                                            <h6 class="text-danger pt-1" id="edit_wrongpassword_confirmation"
                                                style="font-size: 14px;"></h6>
                                    ...
                                    {{-- <div class="form-row">
                                        <div class="form-group col-md-6 col-sm-12">
                                            <label for="contactnumber" style="font-weight: normal;">Contact Number<span
                                                    class="text-danger"><strong>*</strong></span></label>
                                            <input type="text" class="form-control w-75" id="edit_contactnumber"
                                                name="contactnumber" value="">
                                            <h6 class="text-danger pt-1" id="edit_wrongcontactnumber"
                                                style="font-size: 14px;"></h6>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6 col-sm-6">
                                            ...
                                            <h6 class="text-danger pt-1" id="edit_wrongroles" style="font-size: 14px;">
                                            </h6>
