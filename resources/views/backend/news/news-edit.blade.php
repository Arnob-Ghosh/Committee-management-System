                ...
                <div class="col-lg-8">
                    <div class="card card-primary ">
                        <div class="card-header">
                            <h5 class="m-0"><strong><i class="fas fa-plus"></i> Collection Edit</strong></h5>
                        </div>

                        <div class="card-body">
                            <div class="container">

                                <form id="UPDATENewsForm" method="POST" enctype="multipart/form-data">

                                    <input type="hidden" class="form-control w-75" id="news_id" value="{{$news->id}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" class="form-control w-75" name="old_news_thumbnail"
                                        id="old_news_thumbnail" value="{{$news->news_thumbnail}}">
                                        <h6 class="text-danger pt-1" id="wrongnews_thumbnail" style="font-size: 14px;">
                                        </h6>
                                    </div>

                                    <div class="form-group">
                                        <label for="newsimage" class="form-label" style="font-weight: normal;">Collection Title
                                            Image<span class="text-danger"><strong>*</strong></span></label>
                                        <input type="file" class="form-control w-75" name="news_image" id="news_image">
                                        <input type="hidden" class="form-control w-75" name="old_news_image"
                                            id="old_news_image" value="{{$news->news_image}}">

                                        <h6 class="text-danger pt-1" id="wrongnews_image" style="font-size: 14px;">
                                        </h6>
                                    </div>
                                    <div class="form-group">
                                        <label for="news_category" class="form-label" style="font-weight: normal;">Collection
                                            ...
                                            <select name="news_category" class="form-control w-75" id="news_category">
                                                <option value="{{$news->news_category}}"  selected>{{$news->news_category}}</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control w-75" name="accession_number" id="accession_number"
                                            value="{{$news->accession_number}}">

                                        <h6 class="text-danger pt-1" id="wrongaccession" style="font-size: 14px;"></h6>
                                    </div>
                                    <div class="form-group">
                                        <label for="news_description" class="form-label" style="font-weight: normal;">
                                            Description<span class="text-danger"><strong>*</strong></span></label>
                                        ...
                                        <textarea class="ckeditor news_description form-control" id="news_description"
                                            name="news_description" rows="4">"{!!$news->news_description!!}</textarea>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name ="highlight"
                                         value="1" id="flexCheckDefault" {{$news->highlight == 1 ? 'checked' : ''}}>
