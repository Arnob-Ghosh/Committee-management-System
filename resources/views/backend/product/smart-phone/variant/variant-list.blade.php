...
@section('title', 'Smartphone Phone Variant List')
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h5 class="m-0"><strong><i class="fas fa-clipboard-list"></i> Smartphone Phone Variant
                                    List</strong></h5>
                        </div>
                        <div class="card-body">
                            ...
                            <a href="{{url('/smart-phone/variant-create')}}"><button type="button"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="{{asset($item->back_image)}}" width="50px" height="50px"
                                                        alt="image" class="rounded-sqare"> </td>
                                                <td><img src="{{asset($item->over_view_image)}}" width="50px"
                                                        height="50px" alt="image" class="rounded-sqare"> </td>
