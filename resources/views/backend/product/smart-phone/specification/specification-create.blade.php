                ...
                <div class="col-lg-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h5 class="m-0"><strong><i class="fas fa-wallet"></i>SMARTPHONE specificationS</strong></h5>
                        </div>
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <select
                                                        ...
                                                        title="Select brand" data-width="75%" required>
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <select style="width:50%"
                                                        ...
                                                        title="Select Model Name" data-width="75%" required>
...
@section('script')
<script>
    tinymce.init({selector:'textarea',  height: 400,force_br_newlines : true,
        width: 1000, plugins: [
