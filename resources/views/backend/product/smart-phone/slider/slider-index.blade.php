                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{route('smart.phone.slider.create.view')}}"><button type="button"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-info"
                                                    href="{{route('smart.phone.slider.edit.view',$item->id)}}">Edit</a>
                                                <a class="btn btn-danger"
                                                    href="{{route('smart.phone.slider.destroy',$item->id)}}"
                                                    id="delete">Delate</a>
                                            </td>
