...
@section('title', 'Create Smart Phone Model')
                ...
                <div class="col-lg-8">
                    <div class="card card-primary ">
                        <div class="card-header">
                            <h5 class="m-0"><strong><i class="fas fa-plus"></i> Create Smart Phone Model</strong></h5>
                        </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control w-75" name="processor"
                                                    id="processor" placeholder="e.g. Snapdragon 765 ">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control w-75" name="memory" id="memory"
                                                    placeholder="e.g. Ram 8GB , Rom 64 gb ">
