                ...
                <div class="col-lg-8">
                    <div class="card card-primary ">
                        <div class="card-header">
                            <h5 class="m-0"><strong><i class="fas fa-plus"></i> Edit Accessories</strong></h5>
                        </div>

                        <div class="card-body">
                            <div class="container">

                                <form id="EditAccessoriesForm" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <input type="hidden" id="accessories_id" value="{{$data->id}}">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <select
                                                    ...
                                                    <option value="{{ $brand->id }}" {{$data->brand_id == $brand->id ? 'selected': ''}}>{{ $brand->brand_name }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="category_id" class="form-label"
                                                    ...
                                                    <option value="{{ $category->id }}"{{$data->category_id == $category->id ? 'selected': ''}}>{{ $category->category_name }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control w-75" name="product_id"
                                                    id="product_id" value="{{$data->product_id}}" placeholder="e.g. N-1100F">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="file" id="default_image" name="default_image"
                                                    ...
                                                    <input type="hidden" id="old_default_image" name="old_default_image" value="{{$data->default_image}}"  class="form-control w-75">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="file" id="product_image" name="product_image"
                                                    ...
                                                    <input type="hidden" id="old_product_image" name="old_product_image" value="{{$data->product_image}}"  class="form-control w-75">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="file" id="highlighted_spec" name="highlighted_spec"
                                                    class="form-control w-75" >
                                                <input type="hidden" id="old_highlighted_spec" name="old_highlighted_spec" value="{{$data->highlighted_spec}}"  class="form-control w-75">
                                        ...
                                        <div class="col-12">
                                                ...
                                                <div class="form-group">
                                                    <label for="description" class="form-label">Description<span
                                                            class="text-danger"><strong>*</strong></span></label>
                                                    <textarea style="height: 500px;" class="form-control description_area" id="description" name="description"> {!!$data->description!!}</textarea>
