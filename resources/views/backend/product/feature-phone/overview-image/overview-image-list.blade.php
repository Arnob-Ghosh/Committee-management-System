...
@section('title', 'Feature Phone Overview Image
List')
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h5 class="m-0"><strong><i class="fas fa-clipboard-list"></i> FEATURE PHONE OVERVIEW IMAGE
                                    LIST</strong></h5>
                        </div>
                        <div class="card-body">
                            ...
                            <a href="{{url('feature-phone/over-view-image-create')}}"><button type="button"
                                    ...
                                    <table id="model_table" class="display table-bordered " width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('feature.phone.overview.img.edit.view',$item->id)}}"
                                                        class="edit_btn btn btn-info"><i class="fas fa-edit"></i></a>
                                                    <a href="{{route('feature.phone.overview.img.destroy',$item->id)}}"" class="
