    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Dohar Sub-Committee</h2>
          <ol>
            <li><a href="{{ route('homepage') }}">Home</a></li>
            <li><a href="">Dohar Sub-Committee</a></li>
            {{-- <li>Blog Single</li> --}}
          </ol>
        </div>
    ...
    <section id="" class="">
        <div class="container">
            {{-- <div class="section-title">
                <h2>DNBA</h2>
                <p>Our Dohar Sub-Comitee</p>
            </div> --}}
            <div class="row">
                <div class="col-lg-9">
                    <div class="section-title">
                        <h2>DNBA</h2>
                        <p>Our Dohar Sub-Committee</p>
                    </div>
                </div>
                <div class="col-lg-3 my-2">
                    <form action="" method="" id="searchComitee" class="d-flex">
                        <select class="form-select" name="duration" id="duration" aria-label="Default select example" required>
                            ...
                            @foreach ( App\Models\DoharSubComitee::distinct()->get('duration') as $doharSubComitee )
                ...
                @foreach ( $doharSubComitees as $doharSubComitee )
                    <div class="col-lg-3 col-sm-6 my-3">
                        <div class="card h-100">
                            ...
                            <div class="card-body ">
                                <h5 class="card-text text-center"><strong>{{ $doharSubComitee->comitee_designation }}</strong></h5>
