                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:64px;">
                                                            ...
                                                            <img height="auto" src="https://demo.dnba.ahrintl-pvt.com/frontview/img/dnba.png"
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:22px;text-align:left;color:#555;">
                                                Hello {{ $mailData['name'] }}!<br></br>
                                                Have a good day. We're really happy to have you! Please collect the OTP below to login to your account:
                                            </div>
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:14px;line-height:20px;text-align:left;color:#525252;">
                                                Best regards,<br><br> Mr. Csaba Kissi<br>Dohar-Nawabgonj Banker's Association., CEO and Founder<br>
                                                <a href="https://www.dnba.com" style="color:#2F67F6">www.dnba.com</a>
                                            </div>
                                                    ...
                                                    <tr>
                                                        <td align="center" style="font-size:0px;padding:0;word-break:break-word;">
                                                            ...
                                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:12px;font-weight:300;line-height:1;text-align:center;color:#575757;">
                                                                Snehalaya, 102/1-A, Naya Paltan (6th Floor), Box-Culvert Road, Dhaka-1000, Bangladesh
                                                            </div>
